...
var CharactersDescriptionMap = map[string]CharacterDescription {
	...
	Percival: {GOOD, "Merlin and Morgana but does not know who is who",
		...
		"TBD",
		""},
	GoodAngel: {GOOD, "", []string{SUCCESS, REVERSAL},
		[]string{SUCCESS}, "", "", ""},
	Titanya: {GOOD, "",
	...
	Iseult: {GOOD, Tristan,
		...
		[]string{SUCCESS}, "assassin",
		"", ""},
	PrinceClaudin: {GOOD, KingClaudin,
		[]string{SUCCESS},
		[]string{SUCCESS}, "",
	...
	MerlinApprentice: {GOOD, "Percival and assassin but does not know who is who ",
		[]string{SUCCESS},
		[]string{SUCCESS}, "assassin",
		"", ""},
	...
	SirGawain: {GOOD, "",
		[]string{SUCCESS},
		[]string{SUCCESS}, "",
		"", "wins with the goods / if he got murdered instead of merlin or mordred"},
	...
	Oberon: {BAD, "",
		...
		[]string{FAIL}, KingArthur,
		"", "Invisible to evil."},
	BadAngel: {BAD, "All evil",
		[]string{SUCCESS,FAIL,REVERSAL},
		[]string{FAIL}, KingArthur,
		"", ""},
	KingClaudin: {BAD, "All evil and Prince-Claudin",
		[]string{SUCCESS,FAIL},
		[]string{FAIL}, KingArthur,
		"", ""},
	"Ginerva": {NEUTRAL, "",
	...
	TheQuestingBeast: {BAD, "All evil",
		[]string{"Beast. Can vote Success only once"},
		[]string{FAIL}, KingArthur + " or Palinode ",
	...
	Mora: {BAD, "All evil",
		[]string{FAIL, SUCCESS},
		[]string{FAIL, SUCCESS}, KingArthur,
